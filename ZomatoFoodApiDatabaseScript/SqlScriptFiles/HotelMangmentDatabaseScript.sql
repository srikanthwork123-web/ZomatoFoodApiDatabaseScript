...
----
Go
Create OR Alter  Procedure Usp_AddProjectLevelErrorlog(@StatusCode varchar(max),@ErrorMessage varchar(max),@StackTraceError varchar(max),@InnerExceptionError varchar(max),@username varchar(max)=null )  
as begin  
Set nocount on --it prevents the no of rows effected.  
